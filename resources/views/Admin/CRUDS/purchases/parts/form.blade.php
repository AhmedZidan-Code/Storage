...
<div class="col-md-12"> <!-- Changed from col-md-10 to col-md-12 to take full width of the container -->
    <table id="table-details"
        ...
        <tr id="tr-1">
            ...
            <th>
                <input type="text" disabled id="productive_code-1" style="width: 100%;"> <!-- Adjusted width -->
            </th>
            <th>
            ...
            <th>
                <input data-id="1" onchange="callTotal()" onkeyup="callTotal()" type="number" value="1" min="1"
                       name="amount[]" id="amount-1" style="width: 100%;"> <!-- Adjusted width -->
            </th>
            <th>
                <input data-id="1" step=".1" onchange="callTotal()" onkeyup="callTotal()"  type="number" value="1" min="1"
                       name="productive_buy_price[]" id="productive_buy_price-1" style="width: 100%;"> <!-- Adjusted width -->
            </th>
            <th>
                <input type="number" value="0" min="0" name="bouns[]" id="bouns-1" style="width: 100%;"> <!-- Adjusted width -->
            </th>
            <th>
                <input type="number" value="0" min="0" name="discount_percentage[]" id="discount_percentage-1" style="width: 100%;"> <!-- Adjusted width -->
            </th>
            <th>
                <input type="number" value="0" min="0" name="batch_number[]" id="batch_number-1" style="width: 100%;"> <!-- Adjusted width -->
            </th>
            <th>
                <input type="number" disabled value="1" min="1" name="total[]" id="total-1" style="width: 100%;"> <!-- Adjusted width -->
            </th>
            <th>
