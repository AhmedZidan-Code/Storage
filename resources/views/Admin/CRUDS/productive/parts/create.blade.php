...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('productive.store')}}">
    ...
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="one_buy_price" required type="text" min="0" class="form-control form-control-solid" name="one_buy_price" value=""/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="packet_buy_price" required type="text" min="0" class="form-control form-control-solid" name="packet_buy_price" value=""/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="one_sell_price" required type="text" min="0" class="form-control form-control-solid" name="one_sell_price" value=""/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="packet_sell_price" required type="text" min="0" class="form-control form-control-solid" name="packet_sell_price" value=""/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="num_pieces_in_package" required type="number" min="0" class="form-control form-control-solid" name="num_pieces_in_package" value=""/>
        </div>


        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            <!--begin::Label-->
            <label for="product_type" class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                <span class="required mr-1">النوع </span>
            </label>

            <select id="product_type" name="product_type" class="form-control">
                <option selected disabled>اختر </option>
                <option value="tam" > تام</option>
                <option value="kham" >خام</option>
