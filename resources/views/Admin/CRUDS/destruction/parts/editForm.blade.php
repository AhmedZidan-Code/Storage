    ...
    <div class="row my-4 g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <input id="destruction_number" required type="number" class="form-control form-control-solid"
                   name="destruction_number"
                   value="{{$row->destruction_number}}"/>
        </div>
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            <!--begin::Label-->
                    ...
                    <tr id="tr-{{$key}}">
                        ...
                        <th scope="row">
                            <div class="d-flex flex-column mb-7 fv-row col-sm-2 ">
                                ...
                                <select class="getDestructionPrice" data-id="{{$key}}" name="productive_id[]" id='productive_id-{{$key}}'
                                        style='width: 200px;'>
                                    <option selected
                        ...
                        <th>
                            <input data-id="{{$key}}"    class="changeTotal"  type="number" value="{{$pivot->price}}" min="1"
                                   name="price[]" id="price-{{$key}}">

                        </th>
                        <th>
                            <input data-id="{{$key}}" class="changeTotal"   type="number" value="{{$pivot->amount}}" min="1"
                                   name="amount[]" id="amount-{{$key}}">

                        </th>
                        <th>
                            <input disabled  data-id="{{$key}}"   type="number" value="{{$pivot->amount*$pivot->price}}" min="1"
