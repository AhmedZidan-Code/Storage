...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    Route::post('sales/update-status', [\App\Http\Controllers\Admin\SalesController::class, 'updateStatus'])->name('admin.update-sales-status');
    ...
    Route::resource('prepare-items', \App\Http\Controllers\Admin\PreparingItemController::class);
    Route::post('update-status', [\App\Http\Controllers\Admin\PreparingItemController::class, 'updateIsPrepared'])->name('update.prepare-status');
